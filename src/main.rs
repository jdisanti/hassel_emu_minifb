...
// TODO: Reconcile this with the Emulator in hassel_emu when that becomes possible
// Will need to refactor the Bus to not require read_byte_mut in order to do so
pub struct Emulator {
    cpu: Box<Cpu>,
